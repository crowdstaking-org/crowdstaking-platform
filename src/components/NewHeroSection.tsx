    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          {/* For Founders */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border-2 border-blue-200 dark:border-blue-700 hover:shadow-2xl transition-all card-hover flex flex-col h-full">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6 text-center leading-relaxed flex-grow">
            ...
            <Link
              href="/wizard"
              className="w-full flex items-center justify-center space-x-2 bg-blue-600 dark:bg-blue-500 text-white px-8 py-4 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-lg font-bold btn-hover-lift btn-primary-glow mt-auto"
            >
          ...
          {/* For Contributors */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border-2 border-purple-200 dark:border-purple-700 hover:shadow-2xl transition-all card-hover flex flex-col h-full">
            <div className="flex items-center justify-center w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-full mb-6 mx-auto">
            ...
            <Link
              ...
              className="w-full flex items-center justify-center space-x-2 bg-purple-600 dark:bg-purple-500 text-white px-8 py-4 rounded-lg hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors text-lg font-bold btn-hover-lift btn-primary-glow mt-auto"
            >
