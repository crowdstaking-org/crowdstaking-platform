  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        ...
        <button className="bg-blue-600 dark:bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors font-semibold">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border-2 border-red-200 dark:border-red-900">
        ...
        <button className="bg-red-600 dark:bg-red-500 text-white px-6 py-3 rounded-lg hover:bg-red-700 dark:hover:bg-red-600 transition-colors font-semibold">
          Archive Project
        </button>
      </div>
    </div>
