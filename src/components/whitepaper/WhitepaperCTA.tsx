...
/**
 * Final CTA section for Whitepaper page
 * Server Component
 */
export function WhitepaperCTA() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-indigo-50 dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <ScrollReveal direction="up" delay={200} duration={800} scale={true}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="/discover-projects" className="group flex items-center space-x-3 bg-indigo-600 dark:bg-indigo-500 text-white px-8 py-4 rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors text-lg font-semibold w-full sm:w-auto justify-center btn-hover-lift btn-primary-glow ripple">
